...
module DE1_SoC_mm_interconnect_0 (
	...
	wire          displays_ctrl_s1_agent_rp_valid;                                   // displays_ctrl_s1_agent:rp_valid -> router_004:sink_valid
	wire  [113:0] displays_ctrl_s1_agent_rp_data;                                    // displays_ctrl_s1_agent:rp_data -> router_004:sink_data
	wire          displays_ctrl_s1_agent_rp_ready;                                   // router_004:sink_ready -> displays_ctrl_s1_agent:rp_ready
	wire          displays_ctrl_s1_agent_rp_startofpacket;                           // displays_ctrl_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          displays_ctrl_s1_agent_rp_endofpacket;                             // displays_ctrl_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          cmd_mux_002_src_valid;                                             // cmd_mux_002:src_valid -> displays_ctrl_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_002_src_data;                                              // cmd_mux_002:src_data -> displays_ctrl_s1_burst_adapter:sink0_data
	wire          cmd_mux_002_src_ready;                                             // displays_ctrl_s1_burst_adapter:sink0_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                           // cmd_mux_002:src_channel -> displays_ctrl_s1_burst_adapter:sink0_channel
	wire          cmd_mux_002_src_startofpacket;                                     // cmd_mux_002:src_startofpacket -> displays_ctrl_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                       // cmd_mux_002:src_endofpacket -> displays_ctrl_s1_burst_adapter:sink0_endofpacket
	...
	wire    [2:0] displays_ctrl_s1_burst_adapter_source0_channel;                    // displays_ctrl_s1_burst_adapter:source0_channel -> displays_ctrl_s1_agent:cp_channel
	...
	wire          displays_ctrl_s1_agent_rdata_fifo_out_valid;                       // displays_ctrl_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] displays_ctrl_s1_agent_rdata_fifo_out_data;                        // displays_ctrl_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_002:in_0_data
	wire          displays_ctrl_s1_agent_rdata_fifo_out_ready;                       // avalon_st_adapter_002:in_0_ready -> displays_ctrl_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_002_out_0_valid;                                 // avalon_st_adapter_002:out_0_valid -> displays_ctrl_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                  // avalon_st_adapter_002:out_0_data -> displays_ctrl_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                 // displays_ctrl_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                 // avalon_st_adapter_002:out_0_error -> displays_ctrl_s1_agent:rdata_fifo_sink_error
